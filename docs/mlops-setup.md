...
[ML Config](../azure_mlops_stacks/assets/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore azure_mlops_stacks/assets/README.md
...
If you want to use different catalog names, please update the targets declared in the [azure-mlops-stacks/databricks.yml](../azure_mlops_stacks/databricks.yml)
and [azure-mlops-stacks/assets/ml-artifacts-asset.yml](../azure_mlops_stacks/assets/ml-artifacts-asset.yml)
 files. 
...
Follow the instructions in [azure-mlops-stacks/assets/README.md](../azure_mlops_stacks/assets/README.md) to deploy ML assets
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML asset config guide](../azure_mlops_stacks/assets/README.md)  to propose, test, and deploy
