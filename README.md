...
```
azure-mlops-stacks        <- Root directory. Both monorepo and polyrepo are supported.
│
├── azure_mlops_stacks       <- Contains python code, notebooks and ML assets related to one ML project. 
│   │
...
and [ML asset config guide](azure_mlops_stacks/assets/README.md) to propose, test, and deploy changes to production ML code (e.g. update model parameters)
...
| Data Scientist                | Modify production model ML assets, e.g. model training or inference jobs  | [ML asset config guide](azure_mlops_stacks/assets/README.md)                                                     |
